...
namespace PluginMaster
{
    public static class AxesUtils
    {
        ...
        public class SignedAxis
        {
            ...
            private SignedAxis(Axis axis, int sign) => (_axis, _sign) = (axis, sign);
            public static readonly SignedAxis RIGHT = new SignedAxis(Axis.X, 1);
            public static readonly SignedAxis LEFT = new SignedAxis(Axis.X, -1);
            public static readonly SignedAxis UP = new SignedAxis(Axis.Y, 1);
            public static readonly SignedAxis DOWN = new SignedAxis(Axis.Y, -1);
            public static readonly SignedAxis FORWARD = new SignedAxis(Axis.Z, 1);
            public static readonly SignedAxis BACK = new SignedAxis(Axis.Z, -1);
            private static readonly SignedAxis[] _array = new SignedAxis[] { RIGHT, LEFT, UP, DOWN, FORWARD, BACK };
            ...
            public static implicit operator SignedAxis(Axis value) => (value == Axis.X ? RIGHT : value == Axis.Y ? UP : FORWARD);
            public static implicit operator int(SignedAxis value) => value.GetHashCode();
            public static implicit operator SignedAxis(int value) => _array[value];
        ...
        public static Axis[] GetOtherAxes(Axis axis) => (axis == Axis.X ? new Axis[] { Axis.Y, Axis.Z } : axis == Axis.Y ? new Axis[] { Axis.X, Axis.Z } : new Axis[] { Axis.X, Axis.Y });
        ...
        public static Vector3 GetVector(float signedSize, Axis axis) => (axis == Axis.X ? Vector3.right : axis == Axis.Y ? Vector3.up : Vector3.forward) * signedSize;
        public static Vector3 GetVector(Vector3 v, Axis axis) => (axis == Axis.X ? Vector3.right * v.x : axis == Axis.Y ? Vector3.up * v.y : Vector3.forward * v.z);
